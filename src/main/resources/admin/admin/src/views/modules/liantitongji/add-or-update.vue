<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="练题次数" prop="lianticishu">
          <el-input v-model="ruleForm.lianticishu" 
              placeholder="练题次数" clearable  :readonly="ro.lianticishu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="练题次数" prop="lianticishu">
              <el-input v-model="ruleForm.lianticishu" 
                placeholder="练题次数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xingming = true;
          ...
          if(o=='lianticishu'){
            this.ruleForm.lianticishu = obj[o];
	    this.ro.lianticishu = true;
            continue;
          }
          if(o=='dengjiriqi'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `liantitongji/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.liantitongjiCrossAddOrUpdateFlag = false;
                  this.parent.search();
