<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="试卷题目" prop="shijuantimu">
          <el-input v-model="ruleForm.shijuantimu" 
              placeholder="试卷题目" clearable  :readonly="ro.shijuantimu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="试卷题目" prop="shijuantimu">
              <el-input v-model="ruleForm.shijuantimu" 
                placeholder="试卷题目" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="得分分析" prop="defenfenxi">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="得分分析"
                  v-model="ruleForm.defenfenxi" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.defenfenxi" label="得分分析" prop="defenfenxi">
                    <span>{{ruleForm.defenfenxi}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xingming = true;
          ...
          if(o=='shijuantimu'){
            this.ruleForm.shijuantimu = obj[o];
	    this.ro.shijuantimu = true;
            continue;
          }
          if(o=='defen'){
	    ...
	    this.ro.defen = true;
          ...
          if(o=='defenfenxi'){
            this.ruleForm.defenfenxi = obj[o];
	    this.ro.defenfenxi = true;
            continue;
          }
          if(o=='dengjiriqi'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `defentongji/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.defentongjiCrossAddOrUpdateFlag = false;
                  this.parent.search();
